 ...
 *   https://datatables.net/download/#dt/dt-1.10.20/rr-1.2.6/sp-1.0.1
 *
 * Included libraries:
 *   DataTables 1.10.20, RowReorder 1.2.6, SearchPanes 1.0.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.20/rr-1.2.6/sp-1.0.1",
